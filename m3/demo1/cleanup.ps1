# Module 3 Demo 1 - Infrastructure Cleanup
# This script destroys the demo infrastructure using GitHub Actions

param([switch]$Force)

Write-Host "Module 3 Demo 1 - Infrastructure Cleanup" -ForegroundColor Red
...
# Confirm destruction
Write-Host "`nWARNING: This will destroy all infrastructure in the production environment!" -ForegroundColor Red
